...
class AddKarigarController extends GetxController {
  ...
  Future<dynamic> addKarigar(Map<String, String> bodyParams) async {

    try {
      isLoading(true);

      print("Add Karigar url ${API.addKarigar}");

      final response = await http.post(Uri.parse(API.addKarigar),
      ...
      print("Add Karigar response ${responseBody}");
