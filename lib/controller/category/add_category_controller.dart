...
class AddCategoryController extends GetxController {
  ...
  Future<dynamic> addCategory(Map<String, String> bodyParams) async {

    try {
      isLoading(true);

      print("Add Category url ${API.addCategory}");

      final response = await http.post(Uri.parse(API.addCategory),
      ...
      print("Add Category response ${responseBody}");
