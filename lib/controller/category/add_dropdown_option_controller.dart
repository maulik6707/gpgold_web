...
class AddDropdownOptionController extends GetxController {
  ...
  Future<dynamic> addDropdownOptions(Map<String, dynamic> bodyParams) async {

    try {
      isLoading(true);

      print("Add Dropdown options url ${API.addDropdownOption}");

      final response = await http.post(Uri.parse(API.addDropdownOption),
      ...
      print("Add Dropdown options response ${responseBody}");
